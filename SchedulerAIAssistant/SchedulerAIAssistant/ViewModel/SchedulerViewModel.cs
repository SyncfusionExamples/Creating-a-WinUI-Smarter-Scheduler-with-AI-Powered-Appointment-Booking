    ...
    public class SmartSchedulerViewModel : INotifyPropertyChanged
    {
        ...
        public DateTime DisplayDate
        {
            ...
            set
            {
                ...
                this.RaisePropertyChanged(nameof(DisplayDate));
            }
        }
        ...
        public ObservableCollection<AIAssistResourceViewModel> AIAssistResources
        {
            ...
            set
            {
                ...
                this.RaisePropertyChanged(nameof(AIAssistResources));
            }
        }
        ...
        private void GenerateAIAssistResource()
        {
            AIAssistResources =
            [
                new AIAssistResourceViewModel() { Name = "Book an appointment with Dr. Sophia.", ImageName = "/Assets/Scheduler/People_Circle0.png" },
                new AIAssistResourceViewModel() { Name = "Book an appointment with Dr. John.", ImageName = "/Assets/Scheduler/People_Circle1.png" },
            ];
        }
